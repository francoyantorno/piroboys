...
from src.routers import auth_router, user_router, product_router, restaurante_router, plato_router, cliente_router, repartidor_router
...
app.include_router(plato_router.router, prefix="/api")
app.include_router(cliente_router.router, prefix="/api")
app.include_router(repartidor_router.router, prefix="/api")
